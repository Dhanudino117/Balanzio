...
const Dashboard = () => {
  ...
  const graphData = [
    ...
    { date: "Mar 5", expenditure: 250 },
    { date: "Mar 6", expenditure: 400 },
    { date: "Mar 7", expenditure: 600 },
    { date: "Mar 8", expenditure: 350 },
    { date: "Mar 9", expenditure: 500 },
  ];
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex gap-1">
                    ...
                    -
                    <p className="text-gray-400 text-sm">{tx.mode}</p>
                  </div>
                </div>
              </div>
